...
CGameStage3::CGameStage3(LPDIRECT3DDEVICE9 _pGraphicDev)
	: Engine::CScene(_pGraphicDev)
	, m_pPlayer(nullptr)
{
}

CGameStage3::~CGameStage3()
{
}

CGameStage3* CGameStage3::Create(LPDIRECT3DDEVICE9 _pGraphicDev)
{
	CGameStage3* pStage = new CGameStage3(_pGraphicDev);
...
HRESULT CGameStage3::Ready_Scene()
{
...
_int CGameStage3::Update_Scene(const _float& _fTimeDelta)
{
	// 콜라이더 OnOff
...
void CGameStage3::LateUpdate_Scene()
{
	Engine::CScene::LateUpdate_Scene();
	Engine::LateUpdate_Bullet(); //Jonghan Change // Is it Right? becuz BulletManager
}

void CGameStage3::Render_Scene()
{
}

HRESULT CGameStage3::Ready_LightInfo()
{
...
HRESULT CGameStage3::Ready_Layer_Environment(const _tchar* _pLayerTag)
{
...
HRESULT CGameStage3::Ready_Layer_GameLogic(const _tchar* _pLayerTag)
{
	Engine::CLayer* pLayer = CLayer::Create();
...
HRESULT CGameStage3::Ready_Layer_Player(const _tchar* _pLayerTag)
{
	Engine::CLayer* pLayer = CLayer::Create();
	NULL_CHECK_RETURN(pLayer, E_FAIL);
	...
	pGameObject = CPlayer::Create(m_pGraphicDev, _vec3{ 8.5f, 1.f, 1.f });
	NULL_CHECK_RETURN(pGameObject, E_FAIL);
...
HRESULT CGameStage3::Ready_Layer_MonsterBullet(const _tchar* _pLayerTag)
{
	Engine::CLayer* pLayer = CLayer::Create();
	NULL_CHECK_RETURN(pLayer, E_FAIL);
...
// kyubin
HRESULT CGameStage3::Ready_Layer_Effect(const _tchar* _pLayerTag)
{
	Engine::CLayer* pLayer = CLayer::Create();
	NULL_CHECK_RETURN(pLayer, E_FAIL);
...
HRESULT CGameStage3::Ready_Layer_Item(const _tchar* _pLayerTag)
{
	Engine::CLayer* pLayer = CLayer::Create();
	NULL_CHECK_RETURN(pLayer, E_FAIL);
...
void CGameStage3::Set_Collision()
{
...
CLayer* CGameStage3::Find_Layer(const _tchar* _pLayerTag)
{
...
void CGameStage3::MapLoad2(CLayer* _pLayer, CLayer* _pLayer2, CLayer* _pLayer3)
{
