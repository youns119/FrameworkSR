...
HRESULT CUIUpgradeCard::Ready_Unit(_vec3 _vPos)
{
	...
	m_pTransformCom[(_uint)UI_UPGRADE::UPGRADE_CARD]->Set_Scale(140.f, 140.f, 0.f);
	m_pTransformCom[(_uint)UI_UPGRADE::UPGRADE_BOARDER]->Set_Scale(190.f, 160.f, 0.f);
...
void CUIUpgradeCard::Render_Unit()
{
	...
	{
		m_pTransformCom[(_uint)UI_UPGRADE::UPGRADE_CARD]->Set_Scale(140.f * 1.2f, 140.f * 1.2f, 0.f);
