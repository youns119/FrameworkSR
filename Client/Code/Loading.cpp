...
_uint CLoading::Loading_Stage()
{
	...
	FAILED_CHECK_RETURN(Engine::Ready_Proto(L"Proto_MonsterTex", Engine::CTexture::Create(m_pGraphicDev, L"../Bin/Resource/Texture/Monster/Monster%d.png", TEXTUREID::TEX_NORMAL, 13)), E_FAIL);
