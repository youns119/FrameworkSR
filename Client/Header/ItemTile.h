...
END
class CItemTile : public CTileContorl
{
private:
	explicit CItemTile(LPDIRECT3DDEVICE9 _pGraphicDev);
	virtual ~CItemTile();

public:
	static CItemTile* Create_InfoNumber(LPDIRECT3DDEVICE9 _pGraphicDev, _vec3 _vecPos, const _int& _iNumber);
	static CItemTile* Create_InfoNumberTrigger(LPDIRECT3DDEVICE9 _pGraphicDev, _vec3 _vecPos, const _int& _iNumber, const _int& _iTriggerNumber);//10.06
