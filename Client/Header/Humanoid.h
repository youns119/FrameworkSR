...
{
public:
	enum HUMANOIDSTATE { HUMANOID_IDLE, HUMANOID_ATTACK, HUMANOID_ATTACK_DELAY, HUMANOID_HEADSHOT, HUMANOID_PUSH_ONE, HUMANOID_PUSH_TWO, HUMANOID_BULLSHOT, HUMANOID_SHOT_ONE, HUMANOID_SHOT_TWO, HUMANOID_SHIELDATTACK, HUMANOID_END }; //Jonghan Change
