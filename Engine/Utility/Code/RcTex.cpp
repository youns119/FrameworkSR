...
CRcTex::CRcTex(LPDIRECT3DDEVICE9 _pGraphicDev)
	: CVIBuffer(_pGraphicDev)
{
}

CRcTex::CRcTex(const CRcTex& _rhs)
	: CVIBuffer(_rhs)
{
}
...
CRcTex* CRcTex::Create(LPDIRECT3DDEVICE9 _pGraphicDev)
{
	CRcTex* pInstance = new CRcTex(_pGraphicDev);
